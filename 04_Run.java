...
public class Run {
	...
	public static void main(String[] args) {
		...
		// Properties는 주로 외부 외부 설정파일을 읽어오는 또는 파일 형태로 값을 출력하고자 하는 목적으로 사용한다.
		...
		// Properties의 경우 문자열 형태로 키 밸류를 넣을 수 있게끔 제공하는 setProperty("키","밸류"); 메소드
		...
		} catch (IOException e) { //ioe가 부모라서 이것만 예외처리해도 됨
			e.printStackTrace();
		}
		*/
		/*.
		...
		try {
			...
			//            없는 파일을 작성하면 무조건 오류
			//            Root 디렉토리를 제시 안했을 경우 현재 내가 작업중인 자바 프로젝트 폴더로 시작점이 잡힘
